...
function displayProduct()
{
    ...
    if(productid in localStorage)
    {
        ...
        result.innerHTML=`<h3 class="text-danger">product name:${productdetail.proname}</h3>
        <h3 class="text-danger">product id:${productdetail.proid}</h3>
        <h3 class="text-danger">price${productdetail.proprice}</h3>`
    }
    else{
